                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent" style={this.state.toggleMenu ? { display: 'block', transition: '0.3s height ease-in', height: 'auto' } : { display: 'none' }}>
                            <ul className="navbar-nav mx-auto">
                                <li className="nav-item active">
                                    <a className="nav-link popin" href="#">BOOK CAR</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link popin" href="#">HOLIDAYS</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link popin" href="#">SERVICES</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link popin" href="#">INFO</a>
                                </li>
                            </ul>
                        </div>
                    </div>
